...
BOT_API_KEY = '6731074158:AAHIS6z1R5ZplVPJx09SO618Iz8cglOEs8E'
OWNER_ID = [839738393,1481105004]
GODCLOWN = 839738393

bot = telebot.TeleBot(BOT_API_KEY)
AUTHORIZED_USER_IDS = [OWNER_ID,GODCLOWN]  
...
PREMIUM_GROUP_ID = -1002115640182
...
💡 *Note:* Only authorized users can access the bot. Contact @godclown & @scammerverified for authorization.
...
You are not authorized to use this bot. Please contact @godclown & @scammerverified for authorization.
        """
...
🔍 **Checking:** `{current_cc}`
🚪 **Gate:** **Braintree Auth**
👨‍💻 **Developer:** **@godclown & @scammerverified**
                """
...
🛠 **𝗚𝗮𝘁𝗲:** **Braintree Auth**
📝 **𝗗𝗲𝘁𝗮𝗶𝗹𝘀:** {result}
👨‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** @godclown & @scammerverified
    """,
    parse_mode="Markdown"
)
